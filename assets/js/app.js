...
fetchData(url.currentWeather(lat, lon), function (currentWeather) {
  ...
  /** Resto del código aquí */
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
      <h2 class="title-2" id="highlights-label">Aspectos Destacados del Día</h2>
      ...
      <div class="highlight-list">
        ...
        <div class="card card-sm highlight-card two">
          ...
          <h3 class="title-3">Salida y Puesta del Sol</h3>
          ...
          <div class="card-list">
            ...
            <div class="card-item">
              ...
              <div>
                <p class="label-1">Salida del Sol</p>
            ...
            <div class="card-item">
              ...
              <div>
                <p class="label-1">Puesta del Sol</p>
